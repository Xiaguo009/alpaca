...
#define TASK_SYM_NAME(func) _task_ ## func  //_task_func
 ...
 */
 ...
 //func(func of task_t)   _task_func(task_t)
#define TASK(idx, func) \
	void func(); \  //declaration of func
__nv task_t TASK_SYM_NAME(func) = { func, idx }; \   //define a task, namely, _task_func.  task_t.func(task_func_t *)  task_t.idx(task_idx_t)
//__nv task_t _task_func = {  func , idx  }; 
