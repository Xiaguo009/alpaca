...
__nv context_t context_0 = {
	.task = TASK_REF(_entry_task),  //&TASK_SYM_NAME(_entry_task)  //&_task_entry_task(task_t-func+idx)
	//context_0 default task, _task_entry_task,  _task_entry_task.func = _entry_task = TRANSITION_TO(&_task_task_init);
	.needCommit = 0,
};
/**
